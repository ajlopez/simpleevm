...
var FeeGroups = { Zero: 0, Base: 1, VeryLow : 2, Ext: 3 };

var costs = [];

costs[0x30] = FeeGroups.Base;
costs[0x31] = FeeGroups.Ext;
costs[0x32] = FeeGroups.Ext;
costs[0x33] = FeeGroups.Ext;

costs[0x50] = FeeGroups.VeryLow;
costs[0x60] = FeeGroups.VeryLow;
costs[0x61] = FeeGroups.VeryLow;
costs[0x62] = FeeGroups.VeryLow;
